        ...
        <nav className='mx-auto flex max-w-pc flex-1 items-center'>
          <div>
            <Link className='hover:opacity-80' href='/' title={t('title')}>
              <span className='animate-gradient-shift bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-2xl font-bold text-transparent hover:from-blue-500 hover:via-purple-600 hover:to-cyan-400 lg:text-3xl'>
                AI Agent List
              </span>
            </Link>
          </div>
